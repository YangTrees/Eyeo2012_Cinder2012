...
void FlockingApp::setup()
{
	...
	// TEXTURES
	mLanternGlowTex		= gl::Texture( loadImage( loadAsset( "lanternGlow.png" ) ) );
	mGlowTex			= gl::Texture( loadImage( loadAsset( "glow.png" ) ) );
	mNebulaTex			= gl::Texture( loadImage( loadAsset( "nebula.png" ) ) );
	mIconTex			= gl::Texture( loadImage( loadAsset( "iconFlocking.png" ) ), mipFmt );
	
	// LOAD SHADERS
	try {
		mVelocityShader		= gl::GlslProg( loadAsset( "passThru.vert" ),	loadAsset( "Velocity.frag" ) );
		mPositionShader		= gl::GlslProg( loadAsset( "passThru.vert" ),	loadAsset( "Position.frag" ) );
		mP_VelocityShader	= gl::GlslProg( loadAsset( "passThru.vert" ),	loadAsset( "P_Velocity.frag" ) );
		mP_PositionShader	= gl::GlslProg( loadAsset( "passThru.vert" ),	loadAsset( "P_Position.frag" ) );
		mLanternShader		= gl::GlslProg( loadAsset( "lantern.vert" ),	loadAsset( "lantern.frag" ) );
		mRoomShader			= gl::GlslProg( loadAsset( "room.vert" ),		loadAsset( "room.frag" ) );
		mShader				= gl::GlslProg( loadAsset( "VboPos.vert" ),	loadAsset( "VboPos.frag" ) );
		mP_Shader			= gl::GlslProg( loadAsset( "P_VboPos.vert" ),	loadAsset( "P_VboPos.frag" ) );
