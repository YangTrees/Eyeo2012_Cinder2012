...
{	
	...
	try {
		...
		mShardShader	= gl::GlslProg( loadAsset( "shard.vert" ), loadAsset( "shard.frag" ) );
		mFieldShader	= gl::GlslProg( loadAsset( "passThru.vert" ), loadAsset( "field.frag" ) );
	...
	// LOAD TEXTURES
	mGlowTex		= gl::Texture( loadImage( loadAsset( "glow.png" ) ), mipFmt );
	mNebulaTex		= gl::Texture( loadImage( loadAsset( "nebula.png" ) ), mipFmt );
	mCoronaTex		= gl::Texture( loadImage( loadAsset( "corona.png" ) ), mipFmt );
	mIconTex		= gl::Texture( loadImage( loadAsset( "iconForces.png" ) ), mipFmt );
