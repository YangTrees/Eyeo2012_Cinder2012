...
//	mPrevFbo		= 1;
	...
	try {
		...
		mShockwaveShader = gl::GlslProg( loadAsset( "shockwave.vert" ), loadAsset( "shockwave.frag" ) );
		mNodeShader		 = gl::GlslProg( loadAsset( "node.vert" ), loadAsset( "node.frag" ) );
	...
	// LOAD TEXTURES
	mIconTex		= gl::Texture( loadImage( loadAsset( "iconShockwaves.png" ) ), mipFmt );
	mSmokeTex		= gl::Texture( loadImage( loadAsset( "smoke.png" ) ), mipFmt );
