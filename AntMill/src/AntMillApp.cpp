...
{	
	...
	try {
		...
		mPheromoneShader= gl::GlslProg( loadAsset( "passThru.vert" ), loadAsset( "pheromone.frag" ) );
	...
	// LOAD TEXTURES
	mPinTex			= gl::Texture( loadImage( loadAsset( "pin.png" ) ), mipFmt );
	mKernelTex		= gl::Texture( loadImage( loadAsset( "kernel.png" ) ) );
	mHomeTex		= gl::Texture( loadImage( loadAsset( "home.png" ) ) );
	mIconTex		= gl::Texture( loadImage( loadAsset( "iconAntMill.png" ) ), mipFmt );
