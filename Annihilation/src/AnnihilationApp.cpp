...
{	
	...
	try {
		...
		mParticleShader		= gl::GlslProg(  loadAsset( "particle.vert" ),	 loadAsset( "particle.frag" ) );
		mBlurShader			= gl::GlslProg(  loadAsset( "passThru.vert" ),	 loadAsset( "blur.frag" ) );
		mContrastShader		= gl::GlslProg(  loadAsset( "passThru.vert" ),	 loadAsset( "contrast.frag" ) );
		mMatterShader		= gl::GlslProg(  loadAsset( "matter.vert" ),		 loadAsset( "matter.frag" ) );
		mHairShader			= gl::GlslProg(  loadAsset( "hair.vert"	),		 loadAsset( "hair.frag" ) );
		mAntimatterShader	= gl::GlslProg(  loadAsset( "antimatter.vert" ),	 loadAsset( "antimatter.frag" ) );
		mNodesShader		= gl::GlslProg(  loadAsset( "nodes.vert" ),		 loadAsset( "nodes.frag" ) );
	...
	// TEXTURES
	mIconTex		= gl::Texture( loadImage(  loadAsset( "iconAttraction.png" ) ), mipFmt );
	mGlowTex		= gl::Texture( loadImage(  loadAsset( "glow.png" ) ) );
	mSmokeTex		= gl::Texture( loadImage(  loadAsset( "smoke.png" ) ) );
	mKernelTex		= gl::Texture( loadImage(  loadAsset( "kernel.png" ) ) );
	mShadowTex		= gl::Texture( loadImage(  loadAsset( "shadow.png" ) ) );
	mSpectrumTex	= gl::Texture( loadImage(  loadAsset( "spectrum.png" ) ) );
	mWarningTex		= gl::Texture( loadImage(  loadAsset( "warning.png" ) ) );
