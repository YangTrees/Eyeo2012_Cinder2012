...
{	
	...
	try {
		...
		mBalloonsShader = gl::GlslProg( loadAsset( "balloons.vert" ), loadAsset( "balloons.frag" ) );
		mConfettiShader	= gl::GlslProg( loadAsset( "confetti.vert" ), loadAsset( "confetti.frag" ) );
	...
	// LOAD TEXTURES
	mIconTex		= gl::Texture( loadImage( loadAsset( "iconBigBang.png" ) ) );
