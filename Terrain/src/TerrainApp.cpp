...
{	
	...
	try {
		...
		mRdShader		= gl::GlslProg( loadAsset( "passThru.vert" ), loadAsset( "rd.frag" ) );
		mHeightsShader	= gl::GlslProg( loadAsset( "passThru.vert" ), loadAsset( "heights.frag" ) );
		mNormalsShader	= gl::GlslProg( loadAsset( "passThru.vert" ), loadAsset( "normals.frag" ) );
		mTerrainShader	= gl::GlslProg( loadAsset( "terrain.vert" ), loadAsset( "terrain.frag" ) );
		mSphereShader	= gl::GlslProg( loadAsset( "sphere.vert" ), loadAsset( "sphere.frag" ) );
	...
	// LOAD TEXTURES
	mIconTex		= gl::Texture( loadImage( loadAsset( "iconTerrain.png" ) ) );
	...
	mRoomBackWallTex	= gl::Texture( loadImage( loadAsset( "roomWall0.png" ) ) );
	mRoomLeftWallTex	= gl::Texture( loadImage( loadAsset( "roomWall1.png" ) ) );
	mRoomRightWallTex	= gl::Texture( loadImage( loadAsset( "roomWall1.png" ) ) );
	mRoomCeilingTex		= gl::Texture( loadImage( loadAsset( "roomCeiling.png" ) ) );
	mRoomFloorTex		= gl::Texture( loadImage( loadAsset( "roomFloor.png" ) ) );
	mRoomBlankTex		= gl::Texture( loadImage( loadAsset( "roomBlank.png" ) ) );
	...
	mZoomMulti		= 1.0f;
	mZoomMultiDest	= 1.0f;
	mGradientTex	= gl::Texture( loadImage( loadAsset( "gradient.png" ) ) );
	mSandNormalTex	= gl::Texture( loadImage( loadAsset( "sandNormal.png" ) ) );
